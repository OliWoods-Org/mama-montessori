...
export const MONTESSORI_GLOSSARY: MontessoriTerm[] = [
  {
    ...
    translations: { es: "Ambiente Preparado", fr: "Environnement Prepare", de: "Vorbereitete Umgebung", ja: "Seibi sareta kankyo", zh: "Zhunbei hao de huanjing", ar: "al-Bi'a al-Muhayya'a", hi: "Taiyar vatavaran" } as any,
  ...
  },
  {
    ...
    translations: { es: "Periodo Sensible", fr: "Periode Sensible", de: "Sensible Phase", ja: "Binkanna jiki", zh: "Mingan qi" } as any,
  ...
  },
  {
    ...
    translations: { es: "Normalizacion", fr: "Normalisation", de: "Normalisierung", ja: "Seijoka" } as any,
  ...
  },
  {
    ...
    translations: { es: "Control de Error", fr: "Controle de l'Erreur", de: "Fehlerkontrolle" } as any,
  ...
  },
  {
    ...
    translations: { es: "Leccion en Tres Tiempos", fr: "Lecon en Trois Temps", de: "Drei-Stufen-Lektion" } as any,
